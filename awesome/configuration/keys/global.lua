...
local globalKeys =
  ...
  awful.key(
    ...
    'r',
    function()
      awful.spawn('sudo shutdown -r now')
    end,
  ...
  awful.key(
    ...
    'Print',
    function()
      awful.util.spawn_with_shell('sleep 2 && scrot --select $HOME/Imagens/Capturas/%b%d_%H%M%S.png')
    end,
  ...
  awful.key(
    ...
    'p',
    function()
      awful.util.spawn_with_shell('scrot $HOME/Imagens/Capturas/%b%d_%H%M%S.png')
    end,
